...
public class CustomMessages : Singleton<CustomMessages>
{
	...
	public void SendSms(XString text)
	{
		...
		if (this.serverConnection != null && this.serverConnection.IsConnected())
		{
			...
			NetworkOutMessage msg = CreateMessage((byte)TestMessageID.Sms);
    ...
    {
		Debug.Log ("From Custom Messages: Got message");
	...
	public XString ReadText(NetworkInMessage msg)
	{
		return new XString(msg.ReadString());
	}
